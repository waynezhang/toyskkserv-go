...
// #cgo CFLAGS: -I/opt/homebrew/opt/libiconv/include
// #cgo LDFLAGS: -L/opt/homebrew/opt/libiconv/lib -liconv
//
// #include <stdlib.h>
// #include <iconv.h>
//
...
func (iv *Iconv) Convert(s string) string {
	buff := [4096]byte{}
	outptr := &buff[0]
	...
	return string(buff[:len(buff)-int(outlen)])
}
